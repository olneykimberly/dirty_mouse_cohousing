...
cd ../../projects/dirty_mice/CH/bulkRNA
...
# mv the files 
mv R1Samples.txt  /dirty_mouse_cohousing/scripts/R1Samples.txt
mv sampleReadInfo.txt /dirty_mouse_cohousing/scripts/sampleReadInfo.txt

cd /dirty_mouse_cohousing/scripts/
